/*usando o método forEach para percorrer um array mostre as informações de cada pessoa com o seguinte 
formato: "Nome: [nome], Idade: [idade], Cidade: [cidade], salario: [salário], bonus: [bonus]".*/
